              ...
              React.createElement("div", {className: "col-sm-offset-2 col-sm-10"}, 
                React.createElement("div", {className: "row"}, 
                  React.createElement("div", {className: "col-sm-2"}, 
                    React.createElement("button", {type: "submit", className: "btn btn-default", url: "/login", onClick: this.onClick}, "登录")
                  ), 
                  React.createElement("div", {className: "col-sm-3"}, 
                    React.createElement("button", {type: "submit", className: "btn btn-primary", url: "/register", onClick: this.onClick}, "注册试用")
                  )
                )
              )
            )
