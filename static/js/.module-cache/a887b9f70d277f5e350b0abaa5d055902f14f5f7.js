          ...
          React.createElement("form", {class: "form-horizontal"}, 
            React.createElement("div", {class: "form-group"}, 
              ...
              React.createElement("div", {class: "col-sm-7"}, 
                React.createElement("input", {type: "email", class: "form-control", placeholder: "Email"})
              )
            ), 
            React.createElement("div", {class: "form-group"}, 
              React.createElement("label", {for: "inputPassword3", class: "col-sm-2 control-label"}, "Password"), 
              React.createElement("div", {class: "col-sm-7"}, 
                React.createElement("input", {type: "password", class: "form-control", placeholder: "Password"})
              )
            ), 
            React.createElement("div", {class: "form-group"}, 
              React.createElement("div", {class: "col-sm-offset-2 col-sm-10"}, 
                React.createElement("div", {class: "row"}, 
                  React.createElement("div", {class: "col-sm-2"}, 
                    React.createElement("button", {type: "submit", class: "btn btn-default", url: "/login", onClick: this.onClick}, "登录")
                  ), 
                  React.createElement("div", {class: "col-sm-3"}, 
                    React.createElement("button", {type: "submit", class: "btn btn-primary", url: "/register", onClick: this.onClick}, "注册试用")
                  )
                )
              )
            )
