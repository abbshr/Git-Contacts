              ...
              React.createElement("div", {className: "collapse navbar-collapse"}, 
                React.createElement("ul", {className: "nav navbar-nav"}, 
                  React.createElement("li", null, React.createElement("a", {href: "#"}, 
                    "联系人 ", React.createElement("i", {className: "fa fa-users fa-1"})
                  ))
                ), 
                ...
                React.createElement("ul", {className: "nav navbar-nav"}, 
                  React.createElement("li", null, React.createElement("a", {href: "#"}, "个人信息 ", React.createElement("i", {class: "fa fa-user"}))), 
                  React.createElement("li", null, React.createElement("a", {href: "#"}, "全部请求")), 
                  React.createElement("li", null, React.createElement("a", {href: "#"}, "注销 ", React.createElement("i", {class: "fa fa-sign-out"})))
                )
              )
            )
          )
