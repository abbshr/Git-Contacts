    ...
    if (this.state.login)
      ...
      return (
        React.createElement("div", null, 
          React.createElement(Error, {err: this.state.err, status: this.state.status, alertType: "danger"}), 
...
var Error = React.createClass({displayName: "Error",
  render: function () {
    return (
      React.createElement("div", {className: "alert alert-{this.props.alertType} alert-dismissible fade in", role: "alert"}, 
