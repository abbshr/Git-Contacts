    ...
    if (this.state.login)
      ...
      return (
        React.createElement("div", null, 
          React.createElement(Error, {err: this.state.err, status: "Error: ", alertType: "danger", onClosed: this.onAlertClosed}), 
              ...
              React.createElement("div", {className: "col-sm-offset-2 col-sm-10"}, 
                React.createElement("div", {className: "row"}, 
                  React.createElement("div", {className: "col-sm-2"}, 
                    React.createElement("input", {type: "button", className: "btn btn-default", "data-url": "/login", onClick: this.onClick, value: "登录"})
                  ), 
                  React.createElement("div", {className: "col-sm-3"}, 
                    React.createElement("input", {type: "button", className: "btn btn-primary", "data-url": "/register", onClick: this.onClick, value: "注册试用"})
                  )
                )
              )
            )
